                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-flush h-lg-100" id="kt_contacts_main">
                        ...
                        <div class="card-body pt-5">
                            <!--begin::Form-->
                            <form class="form" action="{{ route('blok.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <!--begin::Input group-->
                                <div class="fv-row mb-7">
                                    ...
                                    <select name="tipe_rumah_id" id="tipe_rumah_id" class="form-control">
                                        ...
                                        <option value="{{ $item->id }}" @selected(old('tipe_rumah_id') == $item->id)>{{ $item->tipe }}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Input-->
                                </div>
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control" name="nama_blok" value="{{ old('nama_blok') }}"/>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control" name="kamar" value="{{ old('kamar') }}"/>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                ...
                                <div class="d-flex justify-content-end">
                                    <!--begin::Button-->
                                    <a href="{{ route('blok.index') }}" class="btn btn-light me-3">Cancel</a>
                                    <!--end::Button-->
                                    <!--begin::Button-->
