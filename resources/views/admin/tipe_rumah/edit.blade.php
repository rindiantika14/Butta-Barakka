                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-flush h-lg-100" id="kt_contacts_main">
                        ...
                        <div class="card-body pt-5">
                            <!--begin::Form-->
                            <form class="form" action="{{ route('tipe-rumah.update', $tipeRumah->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                <!--begin::Input group-->
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control" name="tipe" value="{{ old('tipe', $tipeRumah->tipe) }}"/>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <textarea id="kt_docs_tinymce_basic" name="keterangan" class="tox-target">{{ old('keterangan', $tipeRumah->keterangan) }}</textarea>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                <div class="fv-row">
                                    ...
                                    <!--end::Label-->
                                    <br>
                                    <img src="{{ url(Storage::url($tipeRumah->gambar)) }}" alt="Gambar" width="100px">
